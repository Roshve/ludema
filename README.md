...
📖 La documentación de arquitectura completa está en [`ARCHITECTURE.md`](ARCHITECTURE.md) (mapa de referencia), [`CLAUDE.md`](CLAUDE.md) (guía para Claude Code) y [`AGENTS.md`](AGENTS.md) (harness de validación). El trabajo pendiente está en [`ROADMAP.md`](ROADMAP.md).
