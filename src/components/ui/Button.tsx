...
const VARIANTS: Record<Variant, string> = {
  primary:
    "bg-emerald-500 border-emerald-700 text-white hover:brightness-105 disabled:bg-slate-200 disabled:border-slate-300 disabled:text-slate-400 dark:disabled:bg-slate-800 dark:disabled:border-slate-700 dark:disabled:text-slate-500",
